...
#include "scenarios/DrawScenarioBallRLQAC.h"
...
void SetupScenario()
{
	...
	else if (scenario_name == "ball_rl_qac")
	{
		gScenario = std::shared_ptr<cDrawScenarioBallRLQAC>(new cDrawScenarioBallRLQAC(gCamera));
	}
